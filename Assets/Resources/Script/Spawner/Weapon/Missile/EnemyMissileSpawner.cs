...
public class EnemyMissileSpawner : MonoBehaviour
{
    ...
    IEnumerator ShootRoutin()
    {
        ...
        while (true)
        {
            ...
            GameObject bullet = GameManager.Resource.Instantiate("Weapon/Missile/EnemyMissileAttack", transform.position, Quaternion.Euler(90,0,0), GameManager.EnemyBulletParent.transform);
